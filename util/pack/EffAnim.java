...
public class EffAnim<T extends Enum<T> & EffAnim.EffType<T>> extends AnimD<EffAnim<T>, T> {
	...
	public static enum ArmorEff implements EffType<ArmorEff> {
		BUFF("buff"), DEBUFF("debuff");

		private final String path;

		private ArmorEff(String str) {
			path = str;
		}
	...
	public static enum BarEneEff implements EffType<BarEneEff> {
		BREAK("_breaker"), DESTR("_destruction");

		private final String path;

		private BarEneEff(String str) {
			path = str;
		}
	...
	public static enum BarrierEff implements EffType<BarrierEff> {
		BREAK("_breaker"), DESTR("_destruction"), DURING("_during"), START("_start"), END("_end");

		private final String path;

		private BarrierEff(String str) {
			path = str;
		}
	...
	public static enum DefEff implements EffType<DefEff> {
		DEF("");

		private final String path;

		private DefEff(String str) {
			path = str;
		}
	...
	public static interface EffType<T extends Enum<T> & EffType<T>> extends AnimI.AnimType<EffAnim<T>, T> {
		String path();
	}
	...
	public static enum SniperEff implements EffType<SniperEff> {
		IDLE("00"), ATK("01");

		private final String path;

		private SniperEff(String str) {
			path = str;
		}
	...
	public static enum SpeedEff implements EffType<SpeedEff> {
		UP("up"), DOWN("down");

		private final String path;

		private SpeedEff(String str) {
			path = str;
		}
	...
	public static enum VolcEff implements EffType<VolcEff> {
		START("00"), DURING("01"), END("02");

		private final String path;

		private VolcEff(String str) {
			path = str;
		}
	...
	public static enum WarpEff implements EffType<WarpEff> {
		ENTER("_entrance"), EXIT("_exit");

		private final String path;

		private WarpEff(String str) {
			path = str;
		}
	...
	public static enum WeakUpEff implements EffType<WeakUpEff> {
		UP("up");

		private final String path;

		private WeakUpEff(String str) {
			path = str;
		}
	...
	public static enum ZombieEff implements EffType<ZombieEff> {
		REVIVE("revive"), DOWN("_down");

		private final String path;

		private ZombieEff(String str) {
			path = str;
		}
